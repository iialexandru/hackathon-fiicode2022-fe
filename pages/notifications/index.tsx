...
import Child from '../../components/Notifications/Child'
import ChildIWatch from '../../components/Notifications/ChildIWatch'
          ...
          <div className={styles.section}>
              ...
              <div className={styles.section_container}>
                  ...
                  {myChildren.map((child: any, i: number) => {
                      return <Child notifications={child.notifications} key={i} name={child.name} age={child.age} notification={child.notifications[child.notifications.length - 1] ? child.notifications[child.notifications.length - 1].text : ''} id={child._id} />
                  })}
          ...
          <div className={styles.section}>
              ...
              <div className={styles.section_container}>
                  ...
                  {otherChildrenIWatch.map((child: any, i: number) => {
                    return <ChildIWatch notifications={child.notifications} key={i} name={child.name} parent={child.parentName} email={child.parentEmail} id={child._id} />
                  })}
              </div>
